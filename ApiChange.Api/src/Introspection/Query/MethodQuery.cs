...
namespace ApiChange.Api.Introspection
{
    public class MethodQuery : BaseQuery
    {
        ...
        public static MethodQuery ProtectedInternalMethods
        {
          get { return new MethodQuery("protected internal " + All); }
        }
        ...
        internal bool MatchReturnType(MethodDefinition method)
        {
            ...
            return ReturnTypeFilter.IsMatch(method.ReturnType.ReturnType.FullName);
        }
