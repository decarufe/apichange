...
namespace ApiChange.Api.Introspection
{
    public class FieldQuery : BaseQuery
    {
        ...
        static FieldQuery myProtectedInternalFields = new FieldQuery("protected internal " + All);
        public static FieldQuery ProtectedInternalFields
        {
            get { return myProtectedInternalFields; }
        }
