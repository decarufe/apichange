...
namespace ApiChange.Api.Introspection
{
    public class EventQuery : MethodQuery
    {
        ...
        static EventQuery myProtectedInternalEvents = new EventQuery("protected internal * *");
        public static EventQuery ProtectedInternalEvents
        {
          get { return myProtectedInternalEvents; }
        }
